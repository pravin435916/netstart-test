...
function Products() {
    return (
        <div className='w-full flex flex-col py-4 mt-6  justify-center items-center'>
            <span className='text-center mx-2 text-sm font-semibold z-10' >INSTALLED OVER 10 LAKHS STAR RATED PUMPSETS ACROSS THE COUNTRY RESULTING IN A CUMULATIVE SAVING OF MORE THAN 9,000 MILLION UNITS OF POWER FOR THE NATION.</span>
            ...
            <div className='flex flex-col w-[80vw] justify-center items-center gap-2 text-sm font-semibold my-4'>
                <span className='font-bold text-center'>C.R.I. FLUID SYSTEMS PRODUCTS CATER TO DIVERSE SEGMENTS</span>
